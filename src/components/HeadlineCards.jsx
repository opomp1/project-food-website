    ...
    <div className=" max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative ">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          <p className="font-bold text-2xl px-2 pt-4">Roast Chicken</p>
          <p className="px-2">Baked Daily</p>
      ...
      <div className="rounded-xl relative ">
        {/* Overlay */}
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          <p className="font-bold text-2xl px-2 pt-4">Sun's Out, BOBO's Out</p>
      ...
      <div className="rounded-xl relative ">
        ...
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover"
          src="https://images.pexels.com/photos/6441629/pexels-photo-6441629.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt=""
        />
      </div>
    </div>
